...
# MAGIC tar -xvzf /dbfs/$DBFS_LIB/hadoop*tar.gz --directory /opt
# MAGIC tar -xvzf /dbfs/$DBFS_LIB/apache-hive-*tar.gz --directory /opt
# MAGIC 
# MAGIC cp /dbfs/$DBFS_LIB/mariadb*.jar ${TARGET_HIVE_HOME}/lib/mariadb_java_client.jar
